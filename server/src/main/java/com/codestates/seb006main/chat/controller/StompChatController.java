...
public class StompChatController {
    ...
    public void enter(ChatDto.Message message, @Header("access_hh") String accessToken) {
    ...
    public void message(ChatDto.Message message, @Header("access_hh") String accessToken) {
        message.setSenderId(chatService.saveAndSendChatWithSenderId(message, accessToken));
        template.convertAndSend("/sub/chat/room/" + message.getRoomId(), message);
    }

    @MessageMapping("/chat/exit")
    public void exit(ChatDto.Message message, @Header("access_hh") String accessToken) {
        message.setSenderId(chatService.getMemberIdFromToken(accessToken));
